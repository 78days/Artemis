      ...
      <div className="mx-auto flex min-h-screen max-w-7xl flex-col items-center justify-center gap-12 px-6 py-12 lg:flex-row lg:gap-20 lg:px-12">
        ...
        <div className="w-full max-w-xl text-center lg:text-left">
          ...
          <div className="mt-8 flex items-center justify-center gap-4 lg:justify-start">
            <div className="text-4xl font-black text-[#123C32]">$299</div>
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row lg:justify-start">
            <Button
              size="lg"
              className="h-14 rounded-xl bg-[#123C32] px-8 text-base font-semibold text-white shadow-lg transition-all hover:-translate-y-0.5 hover:bg-[#0d3028] hover:shadow-xl"
            >
              Get Started
            </Button>
            ...
            <Button
              variant="outline"
              size="lg"
              className="h-14 rounded-xl border-2 border-[#123C32]/20 bg-white/20 px-8 text-base font-semibold text-[#123C32] backdrop-blur-sm transition-all hover:-translate-y-0.5 hover:bg-white/50"
            >
              Log in
            </Button>
          </div>
